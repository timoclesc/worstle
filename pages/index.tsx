...
export default function Home({
  ...
  return (
    <div className={`bg-light-bg dark:bg-dark-bg w-full h-full flex flex-col`}>
      <Head>
        <title>Next.js Wordle Clone</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <header className="w-full text-black dark:text-white h-16 flex justify-center items-center border-b-gray-500 border-b-2">
